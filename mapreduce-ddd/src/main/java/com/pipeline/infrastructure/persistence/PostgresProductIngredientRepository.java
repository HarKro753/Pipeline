...
public class PostgresProductIngredientRepository implements ProductIngredientRepository {

    private static final String SQL =
            "INSERT INTO product_ingredients (product_barcode, value) VALUES (?, ?) ON CONFLICT DO NOTHING";

    private final DatabaseConfig config;

    public PostgresProductIngredientRepository(DatabaseConfig config) {
        this.config = config;
    }
