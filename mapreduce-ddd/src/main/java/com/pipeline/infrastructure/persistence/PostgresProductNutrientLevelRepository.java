...
public class PostgresProductNutrientLevelRepository implements ProductNutrientLevelRepository {
    ...
    private static final String SQL =
            "INSERT INTO product_nutrient_levels (product_barcode, value) VALUES (?, ?) ON CONFLICT DO NOTHING";
    ...
    public void save(String productBarcode, String value) {
        try (Connection conn = config.getConnection();
            ...
            throw new RuntimeException("Failed to save to product_nutrient_levels: " + value, e);
        }
    }
}
