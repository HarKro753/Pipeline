...
public class Product {
    ...
    public Product(Barcode barcode, String name, String brand,
                   NutriScore nutriScore, NutrientInfo nutrientInfo, List<ProductTag> tags) {
        if (barcode == null) {
    ...
    public void addTag(String tagName) {
        ProductTag tag = new ProductTag(barcode, tagName);
